...
"            <img src=\""+image+"\" alt=\"\" height=\"225\" width=\"290\" />\n" +
"            <p>\n" +
"            	<b>"+name+"</b>\n" +
"                <br>\n" +
"                \n" +
"            </p>"+describe+"\n" +
             "<br>"+
"            <div class=\"boxButton\"><button id=\"button-img\" type='submit' name='PRODUTO' value='"+value+"' >Ver Produto</button></div>\n" +
...
"        </div>");
    ...
    private void handleBodyContentException(Exception ex) throws JspException {
        ...
        throw new JspException("Error in boxTag tag", ex);
    }
